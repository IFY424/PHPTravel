...
public class EmailManager {
	...
	public void sendEmail(List<String> attachments) {
		...
		setToAddress("elinamurat2@gmail.com");
		sendEmail("smtp.gmail.com", "587", "qa.testing.811@gmail.com" , "Muralim811", "Automated Java Email for Selenium",
	...
	public static void main(String[] args) {
		...
		List<String> emptyAttachments = new ArrayList<>();
		emailSender.sendEmail(emptyAttachments);
	}
}
